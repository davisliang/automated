...
def get_data_ag(data_path):
    ...
    return n_classes, word2vec_dic, n_test_data, n_train_data
...
def trainModel(M):
    ...
    if "rotten_tomato" in data_path:
        ...
        n_classes, word2vec_dic, n_test, n_train = get_data_ag(data_path)
    ...
    with sess.as_default():
        ...
        for epoch in range(M.n_epoch):
            ...
            for minibatch in range(n_train_batches):
                encoded_batch, batch_classes, batch_context_encoded, batch_context, batch_identifier, batch_text, batch_length = load_batch(n_classes, word2vec_dic, {}, M.feature_length, M.max_length, data_path+"/Train/", 1, train_file, test_file, all_classes, start_idx, M.batch_size, M.secondary_task)
	    ...
	    accuracy = 0
            ...
            for i in range(n_test_batches):
                encoded_batch, batch_classes, batch_context_encoded, batch_context, batch_identifier, batch_text, batch_length = load_batch(n_classes, word2vec_dic, {}, M.feature_length, M.max_length, data_path+"/Test/", 0, train_file, test_file, all_classes, start_idx, M.batch_size, M.secondary_task)
		start_idx += M.batch_size
